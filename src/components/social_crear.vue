<template>
  <div
    class="timeline_create_article"
    v-loading.body="loadingCreateArticle"
  >
    <div class="timeline_create_article_header">
      <figure class="timeline_create__photo">
        <img
          :src="`${$urlHttp}/imagenes_usuario/imagen_usuario/${currentUser.foto}`"
          alt=""
        >
      </figure>
      <h3 class="timeline_create__text">Escribe algo interesante, para compartir en la seccíon de noticias de la pagina de Kujana.</h3>
    </div>
    ...
    <div class="photos">
      <figure
        class="photo"
        v-for="(photo, index) in urlPhotos"
        :key="index"
      >
        <button
          class="remove_photo"
    ...
    <div class="timeline_create_article_actions">
      ...
      >
        ...
        <p>{{ fileName }}</p>
        <i
          class="material-icons file_delete"
