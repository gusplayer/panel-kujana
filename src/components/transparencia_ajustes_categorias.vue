<template>
	<el-collapse v-model="activeName" accordion>
		<el-collapse-item title="Nombre de la sección" name="0">
			<el-input placeholder="Nombre de la sección" v-model="currentSeccion.titulo"></el-input>
		...
		<el-collapse-item title="Urls externas" name="5">
			...
			<div class="nueva_url_externa">
				...
				<el-button-group>
					<el-button type="primary" v-on:click="createUrl" size="small" icon="circle-check"> Guardar</el-button>
				</el-button-group>
			</div>
		</el-collapse-item>
  ...
  components: { VueEditor },
	...
	methods: {
      ...
      axios.delete(`${this.$urlHttp}/api/secciones/iframes/${id}`).then((response) => {
		...
		reloadIframe(){
			document.getElementById('iframePreview').src = `https://meta.gov.co/transparencia`;
		}
	}
}
</script>
